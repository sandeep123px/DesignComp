...
import Loader from '../Search/loader'
	...
	const [loader,setLoader] = useState('')
	    ...
	    const getResult = async() =>{
			setLoader("true")
			  await
			  fetch(`https://api.odmit.com/api/v1/college-stack?course_type=${courseType}&country=${selectCountry}&qualification=${selectQualification}&category=${selectCategory}&page=1&limit=5&offset=0`)
			   .then((response)=>{
